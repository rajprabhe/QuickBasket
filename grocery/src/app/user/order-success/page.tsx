...
function OrderSucess() {
  return (
    ...
    text-center ">
      ...
      >
        <Package className='w-10 h-16 md:w-20 md:h-20 text-green-500'/>
      </motion.div>
      ...
      >
        ...
        animate-bounce'
        />
        <div className='absolute top-32 left-[30%] w-2 h-2 bg-green-400 rounded-full
        animate-pulse'
        /><div className='absolute top-24 left-[50%] w-2 h-2 bg-green-400 rounded-full
        animate-bounce'
        /><div className='absolute top-16 left-[70%] w-2 h-2 bg-green-400 rounded-full
        animate-pulse'
        />
      </motion.div>
