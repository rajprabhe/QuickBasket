...
function AdminDashboardClient({earning, stats, chartdata}:propType) {
  ...
  return (
    <div className='pt-28 w-[90%] md:w-[80%] mx-auto'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 text-center
        sm:text-left'>
            ...
            {stats.map((s,i)=>{
                ...
                >
                    ...
                    <div>
                        ...
                        <p className='text-gray-800 font-bold text-2xl'>{s.value}</p>
                    </div>
