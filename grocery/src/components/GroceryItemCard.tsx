'use client'
import { addToCart, decreaseQuality, increseQuality } from "@/redux/cartSlice";
  ...
  return (
    ...
    >
        <div className="relative w-full aspect-4/3 bg-gray-50 overflow-hidden group">
          <Image src={item?.image} alt={item.name} fill sizes='(max-width:768px) 100vw, 25vw'
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          {/* when cartItem flase show Add To Cart
          otherwise show + and - buttons */}
