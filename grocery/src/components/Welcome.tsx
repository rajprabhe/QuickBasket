...
function Welcome({nextStep}:propType) {
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6'>
        ...
        >
            Your everyday grocery shopping made simple. From farm-fresh fruits and 
            vegetables to household essentials, find everything you need in 
        ...
        text-white font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-10"
        onClick={()=>nextStep(2)}
        >
            Next
            <ArrowRight/>
